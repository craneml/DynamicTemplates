//
// $Id: MyWindow--createChartsTab.cpp,v 1.3 2010/01/01 20:22:32 igor Exp $
//
...
QWidget* MyWindow::createChartsTab ( QWidget* grandParent )
//  : QWidget(parent)
{
	...
	//------------------------------------------------------------------------------------
	QLabel* daLabel = new QLabel ( tr("Charts Dynamic Templates are coming") ) ;
